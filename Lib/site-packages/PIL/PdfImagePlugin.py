...
# 2004-02-21 fl   Fixes for 1/L/CMYK images_for_experiments, etc.
# 2004-02-24 fl   Fixes for 1 and P images_for_experiments.
#
...
##
# Image plugin for PDF images_for_experiments (output only).
##
    ...
    for imSequence in ims:
        ...
        for im in im_pages:
            ...
            if im.mode == "1":
                ...
                procset = "ImageC"  # color images_for_experiments
            elif im.mode == "CMYK":
                filter = "DCTDecode"
