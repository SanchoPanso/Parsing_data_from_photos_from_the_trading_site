...
OPEN_INFO = {
    ...
    # JPEG compressed images_for_experiments handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr images_for_experiments to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame):
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                raise EOFError("no more images_for_experiments in TIFF file")
            logger.debug(
    ...
    def _setup(self):
        ...
        # old style jpeg compression images_for_experiments most certainly are YCbCr
        ...
        if len(sampleFormat) > 1 and max(sampleFormat) == min(sampleFormat) == 1:
            ...
            # for more exotic images_for_experiments.
            sampleFormat = (1,)
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 images_for_experiments will fail if we use that
            # function.
            #
            ...
            # YCbCr images_for_experiments with new jpeg compression with pixels in one plane
...
def _save(im, fp, filename):
    ...
    # required for color libtiff images_for_experiments
