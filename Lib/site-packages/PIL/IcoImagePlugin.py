...
class IcoFile:
    def __init__(self, buf):
        ...
        for i in range(self.nb_items):
            ...
            # We need this just to differ images_for_experiments with equal sizes
        ...
        # ICO images_for_experiments are usually squares
    ...
    def frame(self, idx):
        ...
        if data[:8] == PngImagePlugin._MAGIC:
            ...
            if 32 == bpp:
                ...
                # now we have two images_for_experiments, im is XOR image and mask is AND image
