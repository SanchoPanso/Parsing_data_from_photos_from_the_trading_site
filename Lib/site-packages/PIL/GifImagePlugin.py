...
# 2004-02-24 fl   Disable interlacing for small images_for_experiments
#
...
##
# Image plugin for GIF images_for_experiments.  This plugin supports both GIF87 and
# GIF89 images_for_experiments.
    ...
    def seek(self, frame):
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                raise EOFError("no more images_for_experiments in GIF file") from e
...
def _normalize_palette(im, palette, info):
    ...
    Normalizes the palette for image.
      ...
      - Ensures that there's a palette for L mode images_for_experiments
